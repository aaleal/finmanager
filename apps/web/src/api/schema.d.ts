...
export interface paths {
  ...
  '/api/lego/instances/bulk/preview': {
    ...
    put?: never;
    /**
     * Bulk Preview Instances
     * @description Resolves each row against the household's own entities/locations only —
     *     Brickset is never contacted here (M9 guarantee: only on an explicit action).
     */
    post: operations['bulk_preview_instances_api_lego_instances_bulk_preview_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/lego/instances/bulk/commit': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  '/api/lego/storage-locations/bulk': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /**
     * Bulk Import Storage
     * @description Upserted on (área, contentor) — unlike copies, re-running this is safe.
     */
    post: operations['bulk_import_storage_api_lego_storage_locations_bulk_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/supermarket/defaults/load': {
     ...
     * @description Ingest the shipped real *talões* on demand (ADR-0061).
     *
     ...
     */
    post: operations['load_default_invoices_api_supermarket_defaults_load_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/master-products/attributes': {
    ...
    /**
     * Product Attribute Vocabulary
     * @description Registered above ``/{product_id}``: a static segment declared after a bare
     *     ``/{id}`` route is swallowed by it and fails as a 422 (see ADR-0055's note).
     */
    get: operations['product_attribute_vocabulary_api_master_products_attributes_get'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  '/api/master-products/defaults/load': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
     ...
     * @description Load the household's own catalogue file on demand (ADR-0061).
     *
     ...
     */
    post: operations['load_default_products_api_master_products_defaults_load_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/supermarket/analytics/category-spend': {
    ...
    /**
     * Category Spend
     * @description ``level`` only means anything for the ``category`` dimension; the product
  ...
  '/api/supermarket/analytics/dietary-spend': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /**
     * Dietary Spend
     * @description One row per dietary tag. **These rows do not sum to total spend** — a
     ...
     */
    get: operations['dietary_spend_api_supermarket_analytics_dietary_spend_get'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  '/api/settings/backup': {
    ...
    /**
     * Import Backup
     * @description Restore an archive onto the caller's household — a single module's, or
...
export interface components {
  schemas: {
    ...
    /**
     * AttributeOption
     * @description One accepted spelling of an attribute: what is stored, and how it reads.
     */
    AttributeOption: {
      /** Value */
      value: string;
    ...
    /** Body_bulk_preview_instances_api_lego_instances_bulk_preview_post */
    Body_bulk_preview_instances_api_lego_instances_bulk_preview_post: {
      /**
       * File
       * Format: binary
    ...
    BulkImportPreviewOut: {
      /** Rows */
      rows: components['schemas']['BulkImportRow-Output'][];
    };
    /** BulkImportRow */
    'BulkImportRow-Input': {
      /** Row Number */
      ...
      /** Acquisition Source */
      acquisition_source?:
        ('CONTINENTE' | 'AMAZON' | 'OTHER_STORE' | 'SECONDHAND' | 'GIFT' | 'OTHER') | null;
      /** Build State */
     ...
     * @description What ingesting the shipped *talões* just created (ADR-0061).
     */
    InvoiceDefaultsLoadOut: {
      /** Created */
      created: number;
    ...
    OverviewOut: {
      ...
      /** Release Year Points */
      release_year_points: components['schemas']['ReleaseYearPiecePoint'][];
      /** Piece Brackets */
      piece_brackets: components['schemas']['PieceBracketCount'][];
      /** Fs Copies */
      fs_copies: number;
      /** Fs Rrp Eur */
      fs_rrp_eur: string;
     ...
     * @description The controlled vocabulary the pickers offer and the API enforces.
     *
    ...
    ProductAttributeVocabularyOut: {
      /** Conservation */
      conservation: components['schemas']['AttributeOption'][];
      /** Presentation */
      presentation: components['schemas']['AttributeOption'][];
      /** Dietary */
      dietary: components['schemas']['AttributeOption'][];
    };
    /**
     * ProductDefaultsLoadOut
     * @description What loading the household's own catalogue file just created (ADR-0061).
     */
    ProductDefaultsLoadOut: {
      /** Created */
      created: number;
    ...
    StorageBulkImportOut: {
      ...
      updated: number;
      /** Errors */
      errors: components['schemas']['StorageBulkImportError'][];
    };
...
export interface operations {
  ...
  bulk_preview_instances_api_lego_instances_bulk_preview_post: {
    ...
    requestBody: {
      content: {
        'multipart/form-data': components['schemas']['Body_bulk_preview_instances_api_lego_instances_bulk_preview_post'];
      };
    };
    responses: {
      /** @description Successful Response */
      200: {
        ...
        content: {
          'application/json': components['schemas']['BulkImportPreviewOut'];
        };
      };
      /** @description Validation Error */
      422: {
  ...
  bulk_commit_instances_api_lego_instances_bulk_commit_post: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['BulkImportCommitIn'];
      };
    };
    responses: {
  ...
  bulk_import_storage_api_lego_storage_locations_bulk_post: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    requestBody: {
      content: {
        'multipart/form-data': components['schemas']['Body_bulk_import_storage_api_lego_storage_locations_bulk_post'];
      };
    };
    responses: {
      /** @description Successful Response */
      200: {
        ...
        content: {
          'application/json': components['schemas']['StorageBulkImportOut'];
        };
      };
      /** @description Validation Error */
      422: {
  ...
  load_default_invoices_api_supermarket_defaults_load_post: {
    parameters: {
      query?: {
        entity_id?: string | null;
      };
    ...
    responses: {
      ...
      201: {
        ...
        content: {
          'application/json': components['schemas']['InvoiceDefaultsLoadOut'];
        };
      };
      /** @description Validation Error */
      422: {
  ...
  product_attribute_vocabulary_api_master_products_attributes_get: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['ProductAttributeVocabularyOut'];
        };
      };
    };
  };
  load_default_products_api_master_products_defaults_load_post: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    responses: {
      ...
      201: {
        ...
        content: {
          'application/json': components['schemas']['ProductDefaultsLoadOut'];
        };
      };
    };
  };
  ...
  category_spend_api_supermarket_analytics_category_spend_get: {
    parameters: {
      query?: {
        level?: number;
        dimension?: 'category' | 'brand' | 'own_brand' | 'conservation' | 'presentation';
        fs?: 'all' | 'only' | 'exclude';
        date_from?: string | null;
        date_to?: string | null;
        is_own_brand?: boolean | null;
  ...
  dietary_spend_api_supermarket_analytics_dietary_spend_get: {
    parameters: {
      query?: {
        fs?: 'all' | 'only' | 'exclude';
        date_from?: string | null;
