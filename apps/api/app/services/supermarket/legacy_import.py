...
from app.services.supermarket import arithmetic, catalogue, prices_service, products_service
from app.services.supermarket.normalize import normalize_description, normalize_merchant_name
    ...
    *,
    ...
    receipt = db.scalar(
        select(SupermarketReceipt).where(
            ...
            SupermarketReceipt.merchant_id == merchant.id,
            SupermarketReceipt.purchased_at == timestamp,
